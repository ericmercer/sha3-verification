...
The two specifications are realigned through a library of methods in \cryptol\ that hide the functional folds and list comprehensions so that the \cryptol\ specification reads more like the \fips\ specification. The two library methods are the \emph{for-method} and the \emph{while-method} discussed in this section.
...
The definition of the \emph{rc} function in \figref{fig:rc} is one such example.
