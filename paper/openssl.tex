...
\figref{fig:iota} shows the difference in the two specifications for the rounding constants with the code for the computed table coming directly from \fips\ in the \openssl\ specification.