...
That is a proof that considers all of \figref{fig:sha3}.
...
That is a proof that only considers \lineref{line:keccak} in \figref{fig:sha3} but holds for any state and is independent of the digest size and rate.
